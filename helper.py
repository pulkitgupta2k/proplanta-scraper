...
def get_prices_milk_butter(link):
    ...
    try:
        product_detail["Allgäu"]["Kleinlimburger"][0] = table1[5].findAll("td")[1].text.replace("\xa0", "")
        product_detail["Allgäu"]["Kleinlimburger"][1] = table1[5].findAll("td")[2].text.replace("\xa0", "")
        product_detail["Allgäu"]["Kleinlimburger"][2] = table1[5].findAll("td")[3].text.replace("\xa0", "")
    except:
        pass
...
# driver()
# pprint(get_prices_egg("https://www.proplanta.de/markt-und-preis/rheinische-warenboerse/aktuelle-eierpreise-08-05-2020_notierungen1588957359.html"))
# pprint(proplanta("https://www.proplanta.de/markt-und-preis/butterpreise_notierungen_r418a25s0_seite_1_von_17.html"))

# pprint(get_prices_milk_butter("https://www.proplanta.de/markt-und-preis/agrarmarkt-berichte/butterpreise-und-kaesepreise-vom-20-12-2017_notierungen1513793071.html"))
# pprint(get_prices_milk_butter("https://www.proplanta.de/markt-und-preis/agrarmarkt-berichte/butterpreise-und-kaesepreise-vom-13-05-2020_notierungen1589389483.html"))